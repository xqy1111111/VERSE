#!/usr/bin/env bash
# Usage:
# bash method_tvr/scripts/run_exp_semantic_hn_hp_pref.sh dset_name ctx_mode vid_feat_type exp_id semantic_cache_path [extra args]
set -euo pipefail
